export default function SocialIcons({ socialName, socialLink, socialIcon, color, borderColor, height, width, fontSize }) {
    ...
    return (
        <a href={socialLink} className={`text-${fontSize} text-${color}`} target="_blank" rel="noopener noreferrer">
            <div className={`h-${height} w-${width} rounded-full border border-${borderColor} flex items-center justify-center`}>
