        ...
        async function fetchData() {
            try {
                ...
                const cards = howWork.card[0]?.ParentsCard?.map((item, index) => ({
                    ...
                    videoSrc: item.image && item.image.length > 0 
