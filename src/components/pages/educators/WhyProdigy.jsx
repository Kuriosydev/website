...
export default function WhyProdigy() {
    ...
    data={prodigySection.card && prodigySection.card.length > 0 ? prodigySection.card.map(card => ({
        imageSrc: card.image && card.image.length > 0 
