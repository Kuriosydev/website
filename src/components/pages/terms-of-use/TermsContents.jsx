...
export default function TermsContents() {
    return (
        <section className={`w-full h-auto bg-white relative overflow-hidden`}>
            <div className="w-full h-full relative overflow-hidden py-10 md:py-10">
                <div className="flex flex-col items-start justify-between gap-8">
                    <Heading
                        ...
                        customStyle="px-8 md:px-20"
                    />
                    <div className="text-lg font-medium px-8 md:px-20">
                        <p className="py-2">PLEASE READ THE TERMS OF USE (“AGREEMENT”) CAREFULLY BEFORE USING THE SERVICES OFFERED BY PRODIGY EDUCATION INC. BY USING THE SERVICES, YOU EXPRESSLY ACKNOWLEDGE THAT YOU HAVE READ AND UNDERSTAND ALL OF THE TERMS OF THIS AGREEMENT AND AGREE TO BE BOUND BY AND COMPLY WITH THIS AGREEMENT, WHICH IS A CONTRACT BETWEEN YOU AND PRODIGY EDUCATION INC. IF YOU DO NOT UNCONDITIONALLY AGREE TO ALL THE TERMS AND CONDITIONS OF THIS AGREEMENT, YOU MAY NOT USE THE SERVICES.</p>

                        <p className="py-2">This clause does not apply to consumers residing in Quebec acting in their individual capacity: THIS AGREEMENT CONTAINS A PROVISION THAT REQUIRES YOU TO RESOLVE ALL DISPUTES WITH PRODIGY ON AN INDIVIDUAL BASIS AND THROUGH FINAL AND BINDING ARBITRATION, RATHER THAN JURY TRIALS OR CLASS ACTIONS, AND ALSO LIMITS THE REMEDIES AVAILABLE TO YOU IN THE EVENT OF A DISPUTE.</p>

                        <p className="py-2">This Agreement applies to your use of Prodigy's games, such as Prodigy Math and Prodigy English, or use of the website, downloadable apps, or other services that Prodigy Education Inc. (“Prodigy,” “Company,” “we,” or “us”) provides at prodigygame.com or any other Prodigy location that links to this Agreement (collectively, the “Services”). In this Agreement, “you” refers to a User of the Services (as defined below).</p>

                        <p className="py-2">Your use of the Services also may be subject to additional terms, conditions, policies, rules or guidelines applicable to the Services or certain features of the Services that we post or provide to you. All such additional terms posted or provided to you during your use of the Services are hereby incorporated by reference into and form a part of this Agreement.
                            Amendments</p>

                        <p className="py-2">Our Services may change from time to time, which means the terms of this Agreement may change too. To the fullest extent permitted by applicable law, Prodigy may amend, in whole or in part, the following sections of these Terms:
                            <p className="py-1">(i) Amendments,</p>
                            <p className="py-1">(ii) User accounts,</p>
                            <p className="py-1">(iii) Use of the services,</p>
                            <p className="py-1">(iv) Prohibited Conduct,</p>
                            <p className="py-1">(v) Acceptable use and code of conduct,</p>
                            <p className="py-1">(vi) Fees, payment and renewing subscriptions,</p>
                            <p className="py-1">(vii) Prodigy content and intellectual property rights,</p>
                            <p className="py-1">(viii) Important health warning about photosensitive seizures,</p>
                            <p className="py-1">(ix) Privacy,</p>
                            <p className="py-1">(x) Advertising,</p>
                            <p className="py-1">(xi) Third-party services,</p>
                            <p className="py-1">(xii) Governing law,</p>
                            <p className="py-1">(xiii) Arbitration and dispute resolution; class action waiver,</p>
                            <p className="py-1">(xiv) Indemnity,</p>
                            <p className="py-1">(xv) Warranty disclaimer,</p>
                            <p className="py-1">(xvi) Limitation of liability,</p>
                            <p className="py-1">(xvii) Termination,</p>
                            <p className="py-1">(xviii) Miscellaneous,</p>
                            <p className="py-1">(xix) Contact.</p>
                        </p>

                        <p className="py-2">If we do update this Agreement, we will notify Users at least thirty (30) days before the update comes into effect. Such notice will be provided by posting the new version on our website and updating its “Effective Date.” If you have an account, we will directly communicate any changes that materially increase the User's obligations or materially reduce Prodigy's obligations under this Agreement to you (e.g., via the contact information associated with a Parent or Educator account, or by displaying an alert upon login to the Services).</p>
                        ...
                        <Heading
                            ...
                            customStyle="py-4"
                        />
                        <p className="py-2">We currently offer accounts to the following types of individuals or organizations that use the Services (each a “User,” and collectively “Users”):</p>
                        ...
                        <p className="py-2">
                            A Student User account can be linked to one or more Parent Users or Educator Users in order to facilitate a continuous learning journey for that Student User both in and outside of the classroom. Any Parent or Educator Users linked to that Student User account will have access to the information in that account, including activity recorded both in and outside of the classroom. Parent Users and Educator Users are responsible for the acts of Student Users linked to their account.
                        </p>
                        ...
                        <p className="py-2">
                            You are solely responsible for any activity that occurs through your account, for maintaining the confidentiality of your account information and password, and for restricting access to your account and your computer. If your account has been compromised or if you suspect unauthorized use of your account, notify us immediately at the contact information provided at the bottom of this Agreement. Without limiting the foregoing, Parent Users and Educator Users who create or are linked to accounts for minor children are responsible for the acts and activities of those children in connection with the use of the Services, and that this Agreement and Prodigy's Privacy Policy for Students will apply to those minor children's use of the Services.
                        </p>
                        ...
                        <p className="py-2">By using the Services, you agree that you will not conduct, conspire to, participate or otherwise engage in fraudulent, abusive, or otherwise illegal activity and that any such activity will be grounds for termination of your right to access or use the Services. Hacking or harming the Services is prohibited. Specifically, you agree that you will not</p>
                        <p className="py-1">(i) post or transmit, or cause to be posted or transmitted, any communication or solicitation designed or intended to obtain password, account, or private information from any other User; </p>
                        <p className="py-1">(ii) use the Services to violate computer or network security measures, transfer or store illegal material (including threatening or obscene material), or engage in any kind of illegal activity; </p>
                        <p className="py-1">(iii) use any automated or non-automated system, including but not limited to “spiders,” “robots,” “offline readers,”“scrapers,” etc., to copy, distribute, disclose, or access the Services, interfere with the proper working of the Services or place an unreasonable load on the Services’ infrastructure; </p>
                        <p className="py-1">(iv) run or activate Maillist, Listserv, or any form of auto-responder or “spam” on the Services; </p>
                        <p className="py-1">(v) attempt to interfere with or decipher any transmissions to or from the servers running the Services;</p>
                        <p className="py-1">(vi) transmit any malicious software agents through the Services; </p>
                        <p className="py-1">(vii) use the Services for any commercial solicitation purposes; </p>
                        <p className="py-1">(viii) interfere with the proper working of the Services; </p>
                        <p className="py-1">(ix) bypass the measures used by Prodigy to prevent or restrict access to the Services.</p>

                        <Heading
                            text="Acceptable use and code of conduct"
                            fontFamily="font-luckiest"
                            fontSize="text-xl md:text-2xl"
                            fontWeight="font-normal"
                            textAlign="text-left"
                        ...
                        <p className="py-2">You agree to adhere to the following rules when using the Services:
                            <p className="py-1">
                                <ul className="list-disc list-inside">
                                    <li>You will not use the Services to violate a person’s right to privacy or otherwise collect, use, or disclose data, including personal information, about other users without their consent or for unlawful purposes.</li>
                                    <li>You will not bully, intimidate, or harass, any User or use the Services in any manner that is threatening, abusive, violent, or harmful to any person or entity.</li>
                                    <li>You will not use the Services in any way to upload, post, transmit, email or otherwise distribute content that: is hate speech, discriminating, defamatory, threatening, pornographic or otherwise obscene; incites violence; contains nudity or graphic or gratuitous violence; or is otherwise objectionable as reasonably determined by Company.</li>
                                    <li>You will not use the Services in any manner that would disparage the Company.</li>
                                    <li>You will not impersonate a Company employee, or any other person, or falsely state or otherwise misrepresent your affiliation with any person or entity.</li>
                                    <li>You will not use the Services in a manner that is harmful to minors. Without limiting the foregoing, you will not transmit or post any content anywhere on the Services, including any User Content (as defined below), that violates child welfare laws, pornography laws, or sexual exploitation laws.</li>
                                    <li>You will not use the Services for any unlawful purpose or that is not in accordance with this Agreement. You agree not to access or use Prodigy or any Prodigy Services for any purpose that is illegal or beyond the scope of the Services’ intended use (in Prodigy’s sole judgment).</li>
                                    <li>You acknowledge and agree that your violation of any of these conditions, at Prodigy’s sole discretion, may result in the immediate suspension or termination of your account and your access to the Services.</li>
                                </ul>
                            </p>
                        </p>

                        <Heading
                            text="Fees, payment, and renewing subscriptions"
                            fontFamily="font-luckiest"
                            fontSize="text-xl md:text-2xl"
                            fontWeight="font-normal"
                            textAlign="text-left"
                        ...
                        <ul className="">
                            ...
                            <li>
                                <Heading
                                    ...
                                    customStyle="py-2"
                                />
                                <p className="py-2">You may cancel your subscription and avoid future billing online via your Parent or Educator account, by contacting our customer support team at the contact information below, or, if you purchased your subscription through a third-party app store, through the respective app store settings. If you do so, we will endeavor to close your account as soon as possible; regardless, we will not charge you for another subscription period if you cancel your subscription prior to its renewal date. For consumers residing in Quebec, we will not charge you any subscription fees following cancellation of your subscription.</p>
                                <p className="py-2">For all accounts, you will continue to have access to your account for the period of time that has already been prepaid. After you cancel your account, we will not charge you any subscription fees after the expiration of your then-current subscription period. In any event, you will be able to continue to use the Services throughout the remainder of the subscription period for which you have already paid. You will also be able to continue to use the parts of the Services that do not require a paid subscription.</p>
                                <p className="py-2"> For consumers residing in Quebec acting in their individual capacity Clause required under the Consumer Protection Act. (Service contract involving sequential performance for instruction, training or assistance) The consumer may cancel this contract at any time by sending the form available here or another notice in writing for that purpose to the merchant. This contract is canceled, without further formality, upon the sending of the form or notice. If the consumer cancels this contract before the merchant has begun the performance of their principal obligation, the consumer has no charge or penalty to pay.</p>

                                <p className="py-2"> If the consumer cancels this contract after the merchant has begun the performance of their principal obligation, the consumer must pay only:
                                    ...
                                    It is in the consumer’s interest to refer to sections 190 to 196 of the Consumer Protection Act (chapter P-40.1) and, where necessary, to communicate with the Office de la protection du consommateur.</p>

                            </li>
                        </ul>

                        <Heading
                            text="Prodigy content and intellectual property rights"
                            fontFamily="font-luckiest"
                            fontSize="text-lg md:text-xl"
                            fontWeight="font-normal"
                            textAlign="text-left"
                        ...
                        <p className="py-2">The Services and its entire contents, features, and functionality, including, but not limited to, all information, software, code, text, displays, graphics, photographs, video, audio, design, presentation, selection, and arrangement (the “Prodigy Content”) are owned by Prodigy and its licensors, and are protected by United States and foreign intellectual property laws, including copyright, trademark and other intellectual property or proprietary rights laws. The Services and all content, features and functionality are intended solely for the personal, non-commercial use by our Users and may only be used in accordance with this Agreement. You agree that your use of the Services does not give you ownership of any intellectual property or other proprietary rights in the Services or the Prodigy Content and as between you and the Company, all such rights in the Services and Prodigy Content, which does not include User Content (as defined below), are owned by and the property of the Company or its licensors, except with respect to User Content created or uploaded by educational institutions, which remains owned by and the property of the educational institution.</p>


                        <p className="py-2">You agree that you will not and will not allow a third party (whether or not for your benefit) to: </p>
                        <ul className="py-2">
                            <li className="py-1">(i) run, license, rent, lease, loan, distribute or sell access to the Services or Prodigy Content; </li>
                            <li className="py-1">(ii) build or support (and/or assist a third party in building or supporting) products or services that compete with the Services or use similar ideas, features, functions, interface or graphics of the Services; </li>
                            <li className="py-1">(iii) use, store, copy, reproduce, modify, translate, publish, broadcast, transmit, distribute, perform, upload, create derivative works from, display, license, sell or otherwise exploit the Services or Prodigy Content for any purposes other than as expressly authorized by this Agreement; </li>
                            <li className="py-1">(iv) decompile, reverse engineer, disassemble, or otherwise attempt to obtain the source code of the Services or Prodigy Content; </li>
                            <li className="py-1">(v) circumvent, disable, or otherwise interfere or alter security related tools or features; </li>
                            <li className="py-1">(vi) remove, obscure or alter any copyright, logo, trademark, or other legal notices or otherwise use the Services in a manner that creates the impression the Services or Prodigy Content belongs to any entity other than Prodigy. Notwithstanding the foregoing,
                                <ul className="py-2 pl-10">
                                    <li>(i) your computer or browser may temporarily store or cache copies of materials being accessed and viewed,</li>
                                    <li>(ii) in the event social media platforms are linked to certain content on the Services, you may take such actions as our Services and such third-party social platforms permit, and</li>
                                    <li>(iii) for downloadable applications only, one copy may be downloaded with any proprietary notices intact, for personal, non-commercial use, pursuant to the terms of this Agreement.</li>
                                </ul>
                            </li>
                        </ul>

                        <p className="py-2">Company will not, under any circumstances, be liable in any way for any Prodigy Content, including, but not limited to, any errors or omissions in any Prodigy Content, or any loss or damage of any kind incurred in connection with use of or exposure to any Prodigy Content posted, emailed, accessed, transmitted, or otherwise made available via the Services.</p>
                        In the course of using the Services, you and other Users may provide content to us, excluding User personally identifying information, which may be used by Prodigy to help support and provide the Services (“User Content”). However, note that Student Users cannot create or upload User Content through the Games. For Prodigy to provide the Services, you hereby grant to Prodigy a limited, non-exclusive, sublicensable, worldwide, royalty-free, and transferable right and license to, whether the User Content is in storage or in transit: (i) use, host, copy, store, distribute, publicly perform and display, publish (in whole or in part), modify, and create derivative works from (such as changes we make so your User Content functions appropriately with the Services) such User Content; (ii) create, use, and disclose metrics and analytics regarding User Content; and (iii) process User Content to improve the Services, develop products, engage in research, provide personally relevant services, or other lawful purposes. By providing User Content, you represent and warrant that (i) you own or have the necessary rights to provide the User Content; (ii) you have the right to grant the license hereof to us and our affiliates and service providers, and each of their and our respective licensees, successors, and assigns to the User Content; (iii) you waive your moral rights in the User Content, and (iv) all User Content complies with applicable laws and regulations.
                        ...
                        The Services and its entire contents, features, and functionality, including, but not limited to, all information, software, code, text, displays, graphics, photographs, video, audio, design, presentation, selection, and arrangement (the “Prodigy Content”) are owned by Prodigy and its licensors, and are protected by United States and foreign intellectual property laws, including copyright, trademark and other intellectual property or proprietary rights laws. The Services and all content, features and functionality are intended solely for the personal, non-commercial use by our Users and may only be used in accordance with this Agreement. You agree that your use of the Services does not give you ownership of any intellectual property or other proprietary rights in the Services or the Prodigy Content and as between you and the Company, all such rights in the Services and Prodigy Content, which does not include User Content (as defined below), are owned by and the property of the Company or its licensors, except with respect to User Content created or uploaded by educational institutions, which remains owned by and the property of the educational institution.
                        ...
                        Privacy
                        For information about Prodigy’s handling of personal information, please review our current Privacy Policy for Students and Privacy Policy for Parents and Educators, which is hereby incorporated by reference.
                        Where a U.S.-based Educator User agrees to this Agreement on behalf of their educational institution, Prodigy agrees that it is under the direct control of the educational institution with regard to that institution’s Students’ personally identifiable information as defined under the Family Educational Rights and Privacy Act (“FERPA”), except to the extent that a Student is linked with a Parent User who then will have the ability to consent to further use of the Student’s personally identifiable information. Prodigy will jointly comply with FERPA, along with the educational institution, by complying with requests from the educational institutions and relevant Educator, Parent, and Student Users, as applicable, to access, correct, and disclose Student personally identifiable information in accordance with this Agreement and the Privacy Policy for Students.
                        Advertising
