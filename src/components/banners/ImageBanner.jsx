...
export default function ImageBanner({
  ...
  return (
    <section
      className={`w-full h-auto ${bgColor} relative z-0 overflow-hidden -mt-28 sm:-mt-28 md:-mt-40 lg:-mt-40 xl:-mt-40`}
    >
          ...
          <div className="flex flex-col w-full h-full items-center justify-center">
            ...
            <div className="flex flex-col w-full h-auto items-center justify-center">
              ...
              <div className="flex flex-row flex-wrap items-center justify-center text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl font-medium px-8 sm:px-10 md:px-20 lg:px-40 xl:px-12 text-justify sm:text-justify md:text-justify lg:text-center xl:text-center">
                Support your child as they discover a new learning journey with
                Kurixel.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row w-full h-full items-center justify-center md:items-start md:justify-start">
            <div className="w-full sm:w-full md:w-full lg:w-7/12 xl:w-7/12 flex flex-col items-center justify-center text-left text-xl ">
              ...
              <div className="flex flex-row flex-wrap items-center justify-center text-base sm:text-base md:text-lg lg:text-lg xl:text-lg font-medium px-8 sm:px-10 md:px-20 lg:px-20 xl:px-20 text-justify sm:text-justify md:text-justify lg:text-left xl:text-left">
                ...
                <p className="py-2 sm:py-2 md:py-2 lg:py-2 xl:py-2">
                  {description}
                </p>
                  ...
                  {buttons.map((button, index) => (
                    <div key={index} className="mt-4 md:mt-0">
                      <ImageButtons
                        ...
                        alt={button.alt || `${button.text} Background`}
                        className={
                          button.className ||
                          "px-10 py-4 sm:py-4 md:px-8 md:py-6 lg:py-8 xl:py-10"
                        }
            ...
            <div className="w-full sm:w-full md:w-full lg:w-5/12 xl:w-5/12 flex flex-col items-center justify-center  text-xl px-4 sm:px-10 md:px-20 lg:px-0 mt-12 md:mt-12 lg:mt-0 xl:mt-0 ml-0 sm:ml-0 md:ml-0 lg:ml-18 xl:ml-20">
              {imgsrc && (
                <img
                  src={imgsrc}
                  alt="image"
                  className="w-auto sm:w-auto md:w-full lg:w-full xl:w-full h-full"
                />
              )}
              {vidSrc && (
                <VideoPreview
