...
export default function SecondaryHeader({ pageName, menu, buttonImgSrc = "/images/Group.png", buttonText, buttonStyles = "mr-6" }) {
    return (
        <header className="bg-black/25 sticky top-1 h-20 overflow-hidden text-black flex items-center justify-between px-4 md:px-[38px] py-4 z-10 backdrop-blur-[10px]">
