...
export default function SecondaryHeader({ pageName, menu, buttonImgSrc = "/images/Group.png", buttonText, buttonStyles = "mr-6" }) {
    return (
        <header className="z-50 md:flex hidden bg-black/25 sticky top-1 h-20 overflow-visible text-black items-center justify-center sm:justify-center lg:justify-between xl:justify-between px-4 md:px-0 lg:px-10 py-4 backdrop-blur-[10px]">
